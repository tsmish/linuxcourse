...
Чтобы установить пакет, нужно воспользоваться графической утилитой или **пакетным менеджером**(В каждом диструбитве свой, например, *dnf* в **Fedora** или *aptitude* в **Debian/Ubuntu**). Пример использования ищите ниже
...
* `apt install <пакет>`- установка пакета *<пакет>* пакетным менеджером *aptitude*
### ping
---
